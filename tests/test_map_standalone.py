"""
Standalone test script for the map system (minimal dependencies).
"""
import sys
import os
...
# Import map modules directly to avoid circular dependencies
from map.map_node import MapNode
from map.map_data import MapData
from map.map_manager import MapManager

# Simple Room class for testing (avoid importing the full rooms module)
class SimpleRoom:
    pass
...
def test_path_selection(manager):
    ...
    if available:
        ...
        # Patch the _create_room_instance method to return a SimpleRoom
        original_create = manager._create_room_instance
        manager._create_room_instance = lambda room_type: SimpleRoom()
        ...
        manager._create_room_instance = original_create
